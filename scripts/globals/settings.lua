...
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 99; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 100; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
SAN_FAME   = 50.000; -- Multiplies fame earned from San d'Oria quests.
BAS_FAME   = 50.000; -- Multiplies fame earned from Bastok quests.
WIN_FAME   = 50.000; -- Multiplies fame earned from Windurst quests.
NORG_FAME  = 50.000; -- Multiplies fame earned from Norg and Tenshodo quests.
JEUNO_FAME = 50.000; -- Multiplies fame earned from Jeuno quests.
